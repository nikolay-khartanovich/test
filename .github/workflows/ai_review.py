...
Найди ТОЛЬКО серьезные проблемы в коде:

**ЧТО АНАЛИЗИРОВАТЬ:**
- Реальные баги и ошибки в логике
...
**ЧТО НЕ АНАЛИЗИРОВАТЬ:**
- Версии зависимостей и пакетов
- Проверки импортов и установки библиотек
- Мелкие улучшения обработки ошибок
- Проверки прав доступа в CI/CD
- Стиль именования переменных
- Мелкие рефакторинги и оптимизации
...
**payment.ts:23** - Списание денег без проверки баланса пользователя
```

Будь прагматичным - блокируй только то, что реально сломает продукт!
"""
